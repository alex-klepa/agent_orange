...
module AgentOrange
  class Device < Base
    ...
    DEVICES = {
      ...
      :bot => 'alexa|bot|crawl(er|ing)|facebookexternalhit|feedburner|google web preview|js\-kit|nagios|postrank|pingdom|slurp|spider|topsy|unwindfetchor|voyager|yahoo!|yandex'
    }
